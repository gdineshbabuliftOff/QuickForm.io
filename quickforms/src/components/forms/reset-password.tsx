...
const ResetPasswordPage = () => {
    ...
    useEffect(() => {
        ...
        verifyPasswordResetCode(auth, code)
            ...
            .catch((error) => {
                setApiError('The password reset code is invalid or has expired. Please try again.');
                setIsVerifying(false);
            });
    }, [searchParams]);
    ...
    if (isVerifying) {
        return (
            <AuthLayout>
                <p className="text-center text-gray-600">Verifying reset code...</p>
            </AuthLayout>
        );
    }
    ...
    return (
        <AuthLayout>
                 ...
                 <Formik
                    ...
                    onSubmit={async (values, { setSubmitting }) => {
                        ...
                        try {
                            ...
                            setApiSuccess('Your password has been reset successfully! You can now log in.');
                        } catch (err: any) {
                        ...
                        <Form className="space-y-4">
                            <div>
                             ...
                             <div>
                                ...
                                <Field type="password" name="confirmPassword" className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" />
            ...
            <p className="text-center text-gray-600 mt-6">
                <button onClick={() => navigateTo('/login')} className="text-indigo-600 cursor-pointer hover:underline font-medium">Back to Log In</button>
            </p>
        </AuthLayout>
    );
};
